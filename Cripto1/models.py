...
class Role(models.Model):
    ...
    name = models.CharField(max_length=100, unique=True)
    description = models.TextField()
    permissions = models.ManyToManyField(Permission, through='Role_permissions', blank=True)
    is_active = models.BooleanField(default=True)
...
# Aggiungere qui la definizione di Role_permissions
class Role_permissions(models.Model):
    ...
    class Meta:
        ...
        verbose_name = "Permesso di Ruolo"
        verbose_name_plural = "Permessi di Ruolo"
